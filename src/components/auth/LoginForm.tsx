  ...
  return (
    <form className="space-y-5" onSubmit={onSubmit}>
      ...
      <div className="flex items-center justify-between gap-3 text-sm">
        ...
        <Link className="font-medium text-[#7c3aed] hover:text-[#6d28d9]" href="/login">
          Forgot password?
        </Link>
      </div>
      ...
      <div className="space-y-2 pt-2 text-center">
        <p className="text-sm text-slate-500">
          For students: No login required to browse items
        </p>
        <p className="text-sm text-slate-500">
          Need access?{' '}
          <Link className="font-medium text-[#7c3aed] hover:text-[#6d28d9]" href="/register">
            Contact IT Support
          </Link>
        </p>
      </div>
